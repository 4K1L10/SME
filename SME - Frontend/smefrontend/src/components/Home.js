    ...
    <div className="home-container">
      ...
      <section className="quick-access">
        ...
        <div className="access-buttons">
          <Link to="/api/guide/view-energy-usage" className="access-btn">Ver Consumo de Energía</Link>
          <Link to="/api/guide/energy-saving-tips " className="access-btn">Consejos de Ahorro</Link>
        </div>
      </section>
      ...
      <p>
  <a href="/api/guide/support-privacy">Contacta con soporte | Ayuda | Términos de privacidad</a>
</p>
      </footer>
    </div>
  );
